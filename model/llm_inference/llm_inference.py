...
class MemoryAugmentedLLMInference:
    ...
    DEFAULT_PROMPT_TEMPLATE = (
        ...
        "- ALWAYS resolve relative times to absolute dates. For example,'yesterday', 'last week', 'last year', 'next month', or similar relative expressions should be resolved to correct date"
        ...
        "- Don't use the posting timestamp as the answer unless the text itself confirms it happened on that exact date.\n\n"

...
def parse_args() -> TrainConfig:
    ...
    # 数据参数
    parser.add_argument('--vector_store_path', type=str, default='/share/home/leiyh5/Memory/data/hierarchical_memory_locomo_total')
    ...
    parser.add_argument('--output_dir', type=str, default='./checkpoints_locomo_total')
    ...
    # 恢复训练
    parser.add_argument('--resume', type=str, default="/share/home/leiyh5/Memory/checkpoints_locomo_total",
                        help='恢复训练的检查点路径')

...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--scored-file",
        type=str,
        default="/share/home/leiyh5/Memory/data/locomo/locomo_qa_test_pred_scored2.json",
        help="Output path for predictions with per-question scores added.",
    )
    parser.add_argument(
        "--stats-file",
        type=str,
        default="/share/home/leiyh5/Memory/data/locomo/locomo_qa_test_pred_stats2.json",
